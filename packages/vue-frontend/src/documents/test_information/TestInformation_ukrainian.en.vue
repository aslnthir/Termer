...
- open the page https://iate.termer.no/install
...
Only concepts in enabled dictionary can be underlined. Concepts may still not be underlined when they:
- accur in links and headings
...
TERMER can only underline when there is an exact match between the text and the concept in the dictionary. You can try to search for a more basic form of a concept by selecting, a part of a it. For example a «member states» are not undelined whereas «member state» is.
...
- When a PDF file is linked from a web page whrere TERMER is applied, you just click to open it with access to the TERMER functionality. Example are this link xxx and the Rescue Handbook that is linked from a website at the Norwegian main rescue center.
- With the PDF button, you can read PDF documents stored locally on a PC. Please try it out from iate.termer.no/search.
