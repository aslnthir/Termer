<template lang="md">
# Terms of use for Tingtun Termer including the Search page

Please read these terms before you use Tingtun Termer or the Search page. Tingtun reserves the right to modify these terms of use with no prior notice. By continuing to use or access the Services or Software after the revisions are in effect, you agree to be bound by the revised Terms. Access to and use of the services is provided under the following conditions.

See the [Tingtun Termer privacy policy](https://termer.no/privacy) for information on this topic.
<br><br>
The content presented through Tingtun Termer or the search page (the services), is compiled and provided for use on the website of the [Norwegian rescue services](https://www.hovedredningssentralen.no/english/) and in the INSITU project. Other use can be granted according to agreement with Tingtun AS (Tingtun).
<br><br>
