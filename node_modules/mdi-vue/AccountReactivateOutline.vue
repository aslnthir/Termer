<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-account-reactivate-outline', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-account-reactivate-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'AccountReactivateOutline icon'
    },
    role: {
      type: String,
      default: 'img'
