<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-sort-calendar-ascending', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-sort-calendar-ascending',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'SortCalendarAscending icon'
    },
    role: {
      type: String,
      default: 'img'
