<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-baseball-diamond-outline', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-baseball-diamond-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'BaseballDiamondOutline icon'
    },
    role: {
      type: String,
      default: 'img'
