<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-face-woman-shimmer-outline', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-face-woman-shimmer-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'FaceWomanShimmerOutline icon'
    },
    role: {
      type: String,
      default: 'img'
