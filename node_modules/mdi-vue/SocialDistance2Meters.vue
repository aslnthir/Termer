<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-social-distance-2-meters', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-social-distance-2-meters',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'SocialDistance2Meters icon'
    },
    role: {
      type: String,
      default: 'img'
