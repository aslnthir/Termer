<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-bag-suitcase-off-outline', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-bag-suitcase-off-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'BagSuitcaseOffOutline icon'
    },
    role: {
      type: String,
      default: 'img'
