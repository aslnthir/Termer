...
var script = {
  name: 'mdi-message-bookmark-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'MessageBookmarkOutline icon'
    },
    role: {
      type: String,
      default: 'img'
      ...
      _c(
        ...
        [
          ...
          _c("path", {
            attrs: {
              d:
                "M18 14V6H13V14L15.5 12.5L18 14M20 2H4C2.9 2 2 2.9 2 4V22L6 18H20C21.1 18 22 17.1 22 16V4C22 2.9 21.1 2 20 2M20 16H6L4 18V4H20V16Z"
            }
          })
        ]
      )
