<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-human-capacity-decrease', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-human-capacity-decrease',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'HumanCapacityDecrease icon'
    },
    role: {
      type: String,
      default: 'img'
