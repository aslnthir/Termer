<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-shield-account-variant-outline', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-shield-account-variant-outline',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'ShieldAccountVariantOutline icon'
    },
    role: {
      type: String,
      default: 'img'
