<template functional>
  <span
    :class="[data.staticClass, 'mdi', 'mdi-human-capacity-increase', props.spin ? 'mdi-spin' : undefined]"
    :role="props.role"
...
<script>
export default {
  name: 'mdi-human-capacity-increase',
  props: {
    width: {
      type: [Number, String],
      default: null
    ...
    ariaLabel: {
      type: String,
      default: 'HumanCapacityIncrease icon'
    },
    role: {
      type: String,
      default: 'img'
